...
train_masks, validation_masks, _, doesntmatter2 = train_test_split(attention_masks, input_ids,random_state=2018, test_size=0.1)

dev_masks, test_masks, _, _ = train_test_split(validation_masks, doesntmatter2,random_state=2018,test_size=0.1)
